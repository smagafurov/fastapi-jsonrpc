...
setup(
    ...
    license='MIT',
    keywords='json-rpc fastapi asgi',
    packages=['fastapi_jsonrpc'],
    package_data={},
    install_requires=['aiojobs==0.*,>=0.2.2', 'fastapi==0.*,>=0.35.0'],
    extras_require={'dev': ['pydantic==0.*,>=0.30.0', 'pygments==2.*,>=2.4.0', 'starlette==0.*,>=0.12.7', 'uvicorn==0.*,>=0.8.6']},
)
